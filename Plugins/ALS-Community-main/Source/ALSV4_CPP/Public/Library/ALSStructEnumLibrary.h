...
private:
	...
	UPROPERTY(VisibleDefaultsOnly, BlueprintReadOnly, meta = (AllowPrivateAccess = true), Category = "ALS|Character States")
	bool MeleeOneHand_ = false;

	UPROPERTY(VisibleDefaultsOnly, BlueprintReadOnly, meta = (AllowPrivateAccess = true), Category = "ALS|Character States")
	bool MeleeAndShield_ = false;
...
public:
	...
	const bool& MeleeOneHand() const { return MeleeOneHand_; }
	const bool& MeleeAndShield() const { return MeleeAndShield_; }
	...
	void operator=(const EALSOverlayState NewAction)
	{
		...
		MeleeOneHand_ = State == EALSOverlayState::MeleeOneHand;
		MeleeAndShield_ = State == EALSOverlayState::MeleeAndShield;
